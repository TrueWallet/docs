...
---
# Social Recovery
_This contract enables several users to regain access to an account in the event of the owner's loss of the private key. This function mitigates the chance of irreversible fund loss and adds an additional layer of security._

[Git Source](https://github.com/TrueWallet/contracts/blob/main/src/guardian/SocialRecovery.sol)
